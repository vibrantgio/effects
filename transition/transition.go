...
func LerpPlatformColors(from, to tokens.PlatformColors, t float64) tokens.PlatformColors {
	return tokens.PlatformColors{
		...
		SidebarSelectionUnemphasized:          tween.LerpNRGBA(from.SidebarSelectionUnemphasized, to.SidebarSelectionUnemphasized, t),
		SidebarSelectionUnemphasizedLabel:     tween.LerpNRGBA(from.SidebarSelectionUnemphasizedLabel, to.SidebarSelectionUnemphasizedLabel, t),
		...
		DefaultButtonFill:                     tween.LerpNRGBA(from.DefaultButtonFill, to.DefaultButtonFill, t),
		...
		ToolbarControlRim:                     tween.LerpNRGBA(from.ToolbarControlRim, to.ToolbarControlRim, t),
